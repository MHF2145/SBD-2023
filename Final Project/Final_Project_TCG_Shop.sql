...
ADD
    CONSTRAINT CollectionCard_CollectionTransaction_P1 FOREIGN KEY CollectionCard_CollectionTransaction_P1 (p1_cc_ID) REFERENCES CollectionCard (cc_ID);

ALTER TABLE
    CollectionTransaction
ADD
    CONSTRAINT CollectionTransaction_CollectionCard_P2 FOREIGN KEY CollectionTransaction_CollectionCard_P2 (p2_cc_ID) REFERENCES CollectionCard (cc_ID);

ALTER TABLE
    CollectionTransaction
ADD
    CONSTRAINT CollectionTransaction_Player_P1 FOREIGN KEY CollectionTransaction_Player_P1 (p1_p_ID) REFERENCES Player (p_ID);

ALTER TABLE
    CollectionTransaction
ADD
    CONSTRAINT CollectionTransaction_Player_P2 FOREIGN KEY CollectionTransaction_Player_P2 (p2_p_ID) REFERENCES Player (p_ID);

ALTER TABLE
    Player
ADD
    CONSTRAINT Player_Membership FOREIGN KEY Player_Membership (p_m_ID) REFERENCES Membership (m_ID);

ALTER TABLE
    ProductShoppingCart
ADD
    CONSTRAINT ProductCatalog_Transaction_ProductCatalog FOREIGN KEY ProductCatalog_Transaction_ProductCatalog (psc_pc_ID) REFERENCES ProductCatalog (pc_ID);

ALTER TABLE
    ProductShoppingCart
ADD
    CONSTRAINT ProductCatalog_Transaction_Transaction FOREIGN KEY ProductCatalog_Transaction_Transaction (psc_pt_ID) REFERENCES Transaction (t_ID);

ALTER TABLE
    Transaction
ADD
    CONSTRAINT ProductTransaction_Employee FOREIGN KEY ProductTransaction_Employee (t_e_ID) REFERENCES Employee (e_ID);

ALTER TABLE
    Transaction
ADD
    CONSTRAINT ProductTransaction_Player FOREIGN KEY ProductTransaction_Player (t_p_ID) REFERENCES Player (p_ID);

ALTER TABLE
    RoomShoppingCart
ADD
    CONSTRAINT Transaction_GameRoom_GameRoom FOREIGN KEY Transaction_GameRoom_GameRoom (rsc_gr_ID) REFERENCES GameRoom (gr_ID);

ALTER TABLE
    RoomShoppingCart
ADD
    CONSTRAINT Transaction_GameRoom_Transaction FOREIGN KEY Transaction_GameRoom_Transaction (rsc_pt_ID) REFERENCES Transaction (t_ID);